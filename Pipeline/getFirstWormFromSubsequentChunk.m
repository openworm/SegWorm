function firstWorm = getFirstWormFromSubsequentChunk(datFileName, chunk0)
% we will try to load the first frame of the subsequent chunk
% Input:
% datFileName - filename of the segmentation result file
% chunk0 - previous chunk
% Output:
% firstWorm - first valid worm from subsequent chunk, chunk0
%
