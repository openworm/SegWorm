function [frames movesI locations] = ...
    findStageMovement(infoFile, logFile, diffFile, verbose, varargin)
...
load(diffFile, 'fps', 'frameDiffs');

% Check the variables.
varName = 'fps';
if ~exist(varName, 'var')
    error('findStageMovement:BadVariable', ...
        ['Cannot load ''' varName ''' from ''' diffFile '''']);
end
varName = 'frameDiffs';
if ~exist(varName, 'var')
    error('findStageMovement:BadVariable', ...
