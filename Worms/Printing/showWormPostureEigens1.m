function [saveFile pages] = showWormPostureEigens1(worm, varargin)
%SHOWWORMPOSTUREEIGENS1 Show the first 3 eigenworm posture projections.
%
%   [SAVEFILE PAGES] = SHOWWORMPOSTUREEIGENS1(WORM)
%
%   [SAVEFILE PAGES] = SHOWWORMPOSTUREEIGENS1(WORM, FILEPREFIX)
%
%   [SAVEFILE PAGES] = SHOWWORMPOSTUREEIGENS1(WORM, FILEPREFIX, PAGE)
%
%   [SAVEFILE PAGES] = SHOWWORMPOSTUREEIGENS1(WORM, FILEPREFIX, PAGE, ISCLOSE)
%
%   Inputs:
...
if ~isempty(varargin) && ~isempty(varargin{1})
    ...
    % Construct the title.
    figureTitle = 'POSTURE: EIGENWORM PROJECTIONS 1-3';
    ...
    saveFile = [varargin{1} '_posture_eigens1.pdf'];
