function [isUsed wormX tickX nameX labelX] = wormInfo2DayOfYear(info, filt)
%WORMINFO2DAYOFYEAR Convert worm information to the day of the year the
%experiment was performed.
%
%   [ISUSED WORMX TICKX NAMEX LABELX] = WORMINFO2DAYOFYEAR(INFO, FILT)
%
%   Inputs:
...
wormX(1,:) = datenum([usedData.year], [usedData.month], [usedData.day]) - ...
    datenum([usedData.year], 1, 0);
...
nameX(1,:) = arrayfun(@(x) datestr(x, 'mmmm dd'), tickX, ...
    'UniformOutput', false);
