function [isUsed wormX tickX nameX labelX] = wormInfo2DayOfWeek(info, filt)
%WORMINFO2DAYOFWEEK Convert worm information to the day of the week the
%experiment was performed.
%
%   [ISUSED WORMX TICKX NAMEX LABELX] = WORMINFO2DAYOFWEEK(INFO, FILT)
%
%   Inputs:
...
dayStrs = {
    ...
    'Sat'
    'Sun'};
nameX(1,:) = arrayfun(@(x) [dayStrs{x} ' (N = ' ...
