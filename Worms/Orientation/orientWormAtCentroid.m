function [worm2 confidence flippedConfidence] = ...
    orientWormAtCentroid(worm1, worm2, samples, varargin)
%ORIENTWORMATCENTROID Orient worm2 to match worm1's orientation (by setting
...
%
% See also SEGWORM, ORIENTWORM, ORIENTWORMPOSTCOIL,
...
c2 = mean(skeleton2.pixels);
translation = c1 - c2;

% Compute the distance between worm 1 and 2 in both orientations
% (controlling for the effects of centroid translation).
...
p2 = [p2(:,1) + translation(1), p2(:,2) + translation(2)];
...
if verbose
    ...
    vWorm2.contour.pixels(:,1) = vWorm2.contour.pixels(:,1) + translation(1);
    vWorm2.contour.pixels(:,2) = vWorm2.contour.pixels(:,2) + translation(2);
    vWorm2.skeleton.pixels(:,1) = vWorm2.skeleton.pixels(:,1) + ...
        translation(1);
    vWorm2.skeleton.pixels(:,2) = vWorm2.skeleton.pixels(:,2) + ...
        translation(2);
